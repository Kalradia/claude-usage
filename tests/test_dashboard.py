...
class TestSessionByModelBreakdown(unittest.TestCase):
    ...
    def setUp(self):
        ...
        insert_turns(conn, [
            ...
            },
            {
                ...
                "output_tokens": 500, "cache_read_tokens": 50,
                "cache_creation_tokens": 30, "cache_creation_1h_tokens": 12,
                "tool_name": None, "cwd": "/tmp",
    ...
    def test_by_model_per_model_sums(self):
        ...
        self.assertEqual(sonnet["cache_creation_1h"], 12)
    ...
    def test_by_model_totals_match_session_totals(self):
        ...
        self.assertEqual(sum(m["cache_creation_1h"] for m in session["by_model"]), session["cache_creation_1h"])
